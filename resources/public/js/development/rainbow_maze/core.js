...
rainbow_maze.core.update_state = (function rainbow_maze$core$update_state(state){
...
rainbow_maze.core.draw_state = (function rainbow_maze$core$draw_state(state){
...
var tr__2188__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(quil.core.width.call(null) / (2)),(quil.core.height.call(null) / (2))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__2188__auto__);

return quil.core.ellipse.call(null,x,y,(100),(100));
}finally {quil.core.pop_matrix.call(null);
}});
rainbow_maze.core.run_sketch = (function rainbow_maze$core$run_sketch(){
rainbow_maze.core.rainbow_maze = (function rainbow_maze$core$run_sketch_$_rainbow_maze(){
...
return quil.sketch.add_sketch_to_init_list.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fn","fn",-1175266204),rainbow_maze.core.rainbow_maze,new cljs.core.Keyword(null,"host-id","host-id",742376279),"rainbow-maze"], null));
}
});
goog.exportSymbol('rainbow_maze.core.run_sketch', rainbow_maze.core.run_sketch);
