...
return (function (p1__2284_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__2284_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_2285 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_2286 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_2285);
var pos_2287 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_2285);
quil.core.scale.call(null,zoom_2286);

var tr__2188__auto___2288 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_2286) - cljs.core.first.call(null,pos_2287)),(((quil.core.height.call(null) / (2)) / zoom_2286) - cljs.core.second.call(null,pos_2287))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__2188__auto___2288);
