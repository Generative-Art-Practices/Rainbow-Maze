...
var vec__2291 = axis;
var a_x = cljs.core.nth.call(null,vec__2291,(0),null);
var a_y = cljs.core.nth.call(null,vec__2291,(1),null);
var a_z = cljs.core.nth.call(null,vec__2291,(2),null);
var vec__2294 = v;
var x = cljs.core.nth.call(null,vec__2294,(0),null);
var y = cljs.core.nth.call(null,vec__2294,(1),null);
var z = cljs.core.nth.call(null,vec__2294,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__2297,p__2298){
var vec__2299 = p__2297;
var u1 = cljs.core.nth.call(null,vec__2299,(0),null);
var u2 = cljs.core.nth.call(null,vec__2299,(1),null);
var u3 = cljs.core.nth.call(null,vec__2299,(2),null);
var vec__2302 = p__2298;
var v1 = cljs.core.nth.call(null,vec__2302,(0),null);
var v2 = cljs.core.nth.call(null,vec__2302,(1),null);
var v3 = cljs.core.nth.call(null,vec__2302,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__2305_SHARP_){
return (p1__2305_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__2306_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__2306_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__2307_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__2307_SHARP_,angle_lr),angle_ud);
...
var map__2309 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__2309__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__2309__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__2311 = cljs.core._EQ_;
var expr__2312 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__2311.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__2312))){
return straight;
} else {
if(cljs.core.truth_(pred__2311.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__2312))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__2311.call(null,quil.middlewares.navigation_3d.space,expr__2312))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__2311.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__2312))){
return up;
} else {
if(cljs.core.truth_(pred__2311.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__2312))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__2311.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__2312))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__2309,map__2309__$1,up,straight){
return (function (p1__2308_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__2308_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__2309,map__2309__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__2314_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__2314_SHARP_);
});})(initial_state))
);
});
/**
...
var map__2315_2326 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2315_2327__$1 = (((((!((map__2315_2326 == null))))?(((((map__2315_2326.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2315_2326.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2315_2326):map__2315_2326);
var vec__2316_2328 = cljs.core.get.call(null,map__2315_2327__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_2329 = cljs.core.nth.call(null,vec__2316_2328,(0),null);
var c_y_2330 = cljs.core.nth.call(null,vec__2316_2328,(1),null);
var c_z_2331 = cljs.core.nth.call(null,vec__2316_2328,(2),null);
var vec__2319_2332 = cljs.core.get.call(null,map__2315_2327__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_2333 = cljs.core.nth.call(null,vec__2319_2332,(0),null);
var u_y_2334 = cljs.core.nth.call(null,vec__2319_2332,(1),null);
var u_z_2335 = cljs.core.nth.call(null,vec__2319_2332,(2),null);
var vec__2322_2336 = cljs.core.get.call(null,map__2315_2327__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_2337 = cljs.core.nth.call(null,vec__2322_2336,(0),null);
var p_y_2338 = cljs.core.nth.call(null,vec__2322_2336,(1),null);
var p_z_2339 = cljs.core.nth.call(null,vec__2322_2336,(2),null);
quil.core.camera.call(null,p_x_2337,p_y_2338,p_z_2339,(p_x_2337 + c_x_2329),(p_y_2338 + c_y_2330),(p_z_2339 + c_z_2331),u_x_2333,u_y_2334,u_z_2335);
